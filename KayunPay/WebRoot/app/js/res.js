...
//					+ (window.location.port==""?"":":"+window.location.port);
	...
	RES["DATA_MAP"]["leftAmountState"] = [] ;
	RES["DATA_MAP"]["leftAmountState"].push({text:"已还完",value:"Y"});
	RES["DATA_MAP"]["leftAmountState"].push({text:"未还完",value:"N"});
	...
	RES["DATA_MAP"]["productType"].push({text:"易分期",value:"E"});
	...
	RES["DATA_MAP"]["vipLevel"].push({text:"新手",value:"1"});
	RES["DATA_MAP"]["vipLevel"].push({text:"普通会员",value:"2"});
	RES["DATA_MAP"]["vipLevel"].push({text:"青铜会员",value:"3"});
	RES["DATA_MAP"]["vipLevel"].push({text:"白银会员",value:"4"});
	RES["DATA_MAP"]["vipLevel"].push({text:"黄金会员",value:"5"});
	RES["DATA_MAP"]["vipLevel"].push({text:"白金会员",value:"6"});
	RES["DATA_MAP"]["vipLevel"].push({text:"钻石会员",value:"7"});
	RES["DATA_MAP"]["vipLevel"].push({text:"黑钻会员",value:"8"});
	RES["DATA_MAP"]["vipLevel"].push({text:"至尊会员",value:"9"});

	RES["DATA_MAP"]["proVipLevel"] = [] ;
	RES["DATA_MAP"]["proVipLevel"].push({text:"新手",value:"新手"});
	RES["DATA_MAP"]["proVipLevel"].push({text:"普通会员",value:"普通会员"});
	RES["DATA_MAP"]["proVipLevel"].push({text:"青铜会员",value:"青铜会员"});
	RES["DATA_MAP"]["proVipLevel"].push({text:"白银会员",value:"白银会员"});
	RES["DATA_MAP"]["proVipLevel"].push({text:"黄金会员",value:"黄金会员"});
	RES["DATA_MAP"]["proVipLevel"].push({text:"白金会员",value:"白金会员"});
	RES["DATA_MAP"]["proVipLevel"].push({text:"钻石会员",value:"钻石会员"});
	RES["DATA_MAP"]["proVipLevel"].push({text:"黑钻会员",value:"黑钻会员"});
	RES["DATA_MAP"]["proVipLevel"].push({text:"至尊会员",value:"至尊会员"});
	...
	RES["DATA_MAP"]["traceType"].push({text:"后台放款",value:"HF"});
	...
	RES["DATA_MAP"]["transferStatus"] = [] ;
	RES["DATA_MAP"]["transferStatus"].push({text:"正常",value:"A"});
	RES["DATA_MAP"]["transferStatus"].push({text:"停用",value:"B"});
	...
	RES["DATA_MAP"]["map_hasMarital"].push({text:"离异",value:"2"});
	RES["DATA_MAP"]["map_hasMarital"].push({text:"丧偶",value:"3"});	
	...
	RES["DATA_MAP"]["map_hasOverdue"] = [];
	RES["DATA_MAP"]["map_hasOverdue"].push({text:"有",value:"1"});
	RES["DATA_MAP"]["map_hasOverdue"].push({text:"无",value:"0"});
	RES["DATA_MAP"]["map_hasOtherP2pLoan"] = [];
	RES["DATA_MAP"]["map_hasOtherP2pLoan"].push({text:"有",value:"1"});
	RES["DATA_MAP"]["map_hasOtherP2pLoan"].push({text:"无",value:"0"});
	RES["DATA_MAP"]["map_hasLiabilities"] = [];
	RES["DATA_MAP"]["map_hasLiabilities"].push({text:"有",value:"1"});
	RES["DATA_MAP"]["map_hasLiabilities"].push({text:"无",value:"0"});
...
//	RES["DATA_MAP"]["map_tixianStatus"].push({text:"审核不通过",value:"5"});
	...
	RES["DATA_MAP"]["map_applyState"].push({text:"待信审",value:"A"});
	RES["DATA_MAP"]["map_applyState"].push({text:"临时保存",value:"B"});
	RES["DATA_MAP"]["map_applyState"].push({text:"信审失败",value:"C"});
	RES["DATA_MAP"]["map_applyState"].push({text:"待风控审核",value:"D"});
	RES["DATA_MAP"]["map_applyState"].push({text:"风控审核失败",value:"G"});
	RES["DATA_MAP"]["map_applyState"].push({text:"已制作新标",value:"E"});
	RES["DATA_MAP"]["map_applyState"].push({text:"已放款",value:"Y"});
	...
	RES["DATA_MAP"]["map_czfs"] = [] ;
	RES["DATA_MAP"]["map_czfs"].push({text:"快捷充值",value:"FAST"});
	RES["DATA_MAP"]["map_czfs"].push({text:"网银充值",value:"WY"});
	RES["DATA_MAP"]["map_czfs"].push({text:"手机充值",value:"PHONE"});
	RES["DATA_MAP"]["map_czfs"].push({text:"人工",value:"SYS"});
	RES["DATA_MAP"]["map_czfs"].push({text:"连连支付",value:"LL"});
	RES["DATA_MAP"]["map_czfs"].push({text:"网银在线",value:"WYZX"});
	//RES["DATA_MAP"]["map_czfs"].push({text:"宝付",value:"BFZF"});
	RES["DATA_MAP"]["map_czfs"].push({text:"商银信",value:"SYX"});
	
	RES["DATA_MAP"]["map_txfs"] = [] ;
	RES["DATA_MAP"]["map_txfs"].push({text:"即信支付",value:"Jixin"});
	RES["DATA_MAP"]["map_txfs"].push({text:"富友支付",value:"Fuiou"});
	RES["DATA_MAP"]["map_txfs"].push({text:"连连支付",value:"LL"});
	RES["DATA_MAP"]["map_txfs"].push({text:"商银信",value:"SYX"});
	RES["DATA_MAP"]["map_txfs"].push({text:"人工",value:"SYS"});
	...
	RES["DATA_MAP"]["setRemarkRateType"] = [] ;
	RES["DATA_MAP"]["setRemarkRateType"].push({text:"1%(无门槛)",value:"X1"});
	RES["DATA_MAP"]["setRemarkRateType"].push({text:"1.5%(无门槛)",value:"X2"});
	RES["DATA_MAP"]["setRemarkRateType"].push({text:"2%(无门槛)",value:"X3"});
	RES["DATA_MAP"]["setRemarkRateType"].push({text:"3%(无门槛)",value:"X4"});
	...
	RES["DATA_MAP"]["mType"].push({text:"现金奖券",value:"C"});
	RES["DATA_MAP"]["mType"].push({text:"加息奖券",value:"X"});
	
	RES["DATA_MAP"]["templateStatus"] = [];
	RES["DATA_MAP"]["templateStatus"].push({text:"可用",value:"A"});
	RES["DATA_MAP"]["templateStatus"].push({text:"禁用",value:"B"});
	
	RES["DATA_MAP"]["isStatus"] = [] ;
	RES["DATA_MAP"]["isStatus"].push({text:"未处理",value:"0"});
	RES["DATA_MAP"]["isStatus"].push({text:"已处理",value:"1"});
	RES["DATA_MAP"]["isStatus"].push({text:"已处理",value:"2"});//补抽
	
	RES["DATA_MAP"]["map_sex"] = [] ;
	RES["DATA_MAP"]["map_sex"].push({text:"男",value:"M"});
	RES["DATA_MAP"]["map_sex"].push({text:"女",value:"F"});
	
	RES["DATA_MAP"]["loanTimeLimit"] = [];
	RES["DATA_MAP"]["loanTimeLimit"].push({text:"1月", value:"1"});
	RES["DATA_MAP"]["loanTimeLimit"].push({text:"2月", value:"2"});
	RES["DATA_MAP"]["loanTimeLimit"].push({text:"3月", value:"3"});
	RES["DATA_MAP"]["loanTimeLimit"].push({text:"6月", value:"6"});
	RES["DATA_MAP"]["loanTimeLimit"].push({text:"9月", value:"9"});
	RES["DATA_MAP"]["loanTimeLimit"].push({text:"12月", value:"12"});
	RES["DATA_MAP"]["loanTimeLimit"].push({text:"18月", value:"18"});
	RES["DATA_MAP"]["loanTimeLimit"].push({text:"24月", value:"24"});

	RES["DATA_MAP"]["map_loanUserType"] = [];
	RES["DATA_MAP"]["map_loanUserType"].push({text:"个人", value:"0"});
	RES["DATA_MAP"]["map_loanUserType"].push({text:"企业", value:"1"});
	
	RES["DATA_MAP"]["questionType"] = [] ;
	RES["DATA_MAP"]["questionType"].push({text:"注册登录",value:"A"});
	RES["DATA_MAP"]["questionType"].push({text:"存管账户",value:"B"});
	RES["DATA_MAP"]["questionType"].push({text:"投标",value:"C"});
	RES["DATA_MAP"]["questionType"].push({text:"债权转让",value:"D"});
	RES["DATA_MAP"]["questionType"].push({text:"自助服务",value:"E"});
	RES["DATA_MAP"]["questionType"].push({text:"充值提现",value:"F"});
	RES["DATA_MAP"]["questionType"].push({text:"会员等级",value:"G"});
	
	RES["DATA_MAP"]["isUsually"] = [] ;
	RES["DATA_MAP"]["isUsually"].push({text:"是 : 前台显示常见问题",value:"Y"});
	RES["DATA_MAP"]["isUsually"].push({text:"否 ：前台不显示常见问题",value:"N"});
	
	RES["DATA_MAP"]["identity"] = [];
	RES["DATA_MAP"]["identity"].push({text:"借款人账户",value:"2"});
	RES["DATA_MAP"]["identity"].push({text:"担保账户",value:"3"});
	/*RES["DATA_MAP"]["identity"].push({text:"红包账户",value:"4"});
	RES["DATA_MAP"]["identity"].push({text:"手续费账户",value:"5"});*/
	
	RES["DATA_MAP"]["idType"] = [];
	RES["DATA_MAP"]["idType"].push({text:"身份证",value:"01"});
	/*RES["DATA_MAP"]["idType"].push({text:"组织机构代码证",value:"20"});
	RES["DATA_MAP"]["idType"].push({text:"企业社会信用代码",value:"25"});*/
	
	RES["DATA_MAP"]["routeCode"] = [];
	RES["DATA_MAP"]["routeCode"].push({text:"普通提现",value:"1"});
	RES["DATA_MAP"]["routeCode"].push({text:"大额提现",value:"2"});
	
	RES["DATA_MAP"]["transStatus"] = [] ;
	RES["DATA_MAP"]["transStatus"].push({text:"待承接",value:"1"});
	RES["DATA_MAP"]["transStatus"].push({text:"批量债转中(待银行处理)",value:"2"});
})();