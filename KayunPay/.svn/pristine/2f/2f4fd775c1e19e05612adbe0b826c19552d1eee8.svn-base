...
public class RepaymentCountService extends BaseService {
	...
	public boolean updateRepaymentCount(String repaymentDate,String repaymentYesDate){
		...
		List<LoanInfo> loanInfos = LoanInfo.loanInfoDao.find("select * from t_loan_info where backDate = ? and loanState='N' and productType='E' and clearDate!=?",repaymentDate,DateUtil.getStrFromDate(new Date(), "MMdd"));
