...
public class FileOperate {
	 ...
	 * @return 返回逐行文本文件的内容
	 */
	public String[] readTxtLine(String filePathAndName, String encoding)
			throws IOException {
		encoding = encoding.trim();
		...
		return (String[]) sr.toArray(new String[0]);
	}
	...
	public void createFile(String filePathAndName, String fileContent,
		...
		try {
			...
			if (!myFilePath.exists()) {
				File path = new File(filePathAndName.substring(0, filePathAndName.lastIndexOf("/")));
				if (!path.exists()) {
					path.mkdir();
				}
