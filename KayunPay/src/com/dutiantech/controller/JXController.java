...
public class JXController extends BaseController {
	...
	public static void creditInvest(Map<String, String> reqMap,String accountId, long txAmount, long txFee, long tsfAmount,
		...
		reqMap.put("retUrl", CommonUtil.ADDRESS+"/Z02?navTab=2");// 返回交易页面链接
	 ...
	 * @return
	 */
	public static Map<String, String> batchCreditInvest(Map<String, String> reqMap, int batchNo, String jsonStr) {
		reqMap.put("txCode", "batchCreditInvest");// 交易代码
		reqMap.put("batchNo", String.valueOf(batchNo));// 批次号
		reqMap.put("notifyURL", CommonUtil.NIUX_URL+"/batchCreditInvestNotifyURL");// 后台通知链接
		reqMap.put("retNotifyURL", CommonUtil.NIUX_URL+"/batchCreditInvestNotifyURL");// 业务结果通知
		...
		for (int i = 0; i < array.size(); i++) {
			...
			map.put("orderId", jsonObject.getString("orderId"));// 订单号
			map.put("txAmount", StringUtil.getMoneyYuan(txAmount));// 交易金额
	 ...
	 * @return
	 */
	public static Map<String, String> batchSubstRepay(int batchNo, String retNotifyURL,String jsonStr) {
	...
	public static void paymentAuthPage(String accountId, String maxAmt, String deadline, HttpServletResponse response) {
		...
		reqMap.put("retUrl", CommonUtil.ADDRESS + "/index");// 返回交易页面链接
		reqMap.put("successfulUrl", CommonUtil.ADDRESS + "/C01?verifyAuth=y");
	...
	/**
	 * 20180831起接口失效
	 * 密码重置增强(页面接口) 必须曾经设置过电子账户密码，验证短信验证码密码重置之前要先调用发短信接口。
	 * 
	 * @param jxAccountId
	 *            电子账号
	 * @param idType
	 ...
	 * 			 交易成功跳转链接(可选)
	 */
	public void passwordResetPlus(String jxAccountId, String idType, String idNo, String name, String mobile,
	 ...
	 * @param response
	 */
	public static void passwordReset(String jxAccountId, String idType, String idNo, String name, String mobile, String retUrl, String notifyUrl, HttpServletResponse response) {
		Map<String, String> reqMap = new HashMap<String, String>();
		JXService.getHeadReq(reqMap);
	...
	public static  Map<String, String> debtRegister(String jxAccountId, String productId, String raiseDate,
			String raiseEndDate, String intType, String intPayDay, String duration, String txAmount, String rate,
			String bailAccountId,String txFee) {
		Map<String, String> reqMap = new HashMap<String, String>();
		JXService.getHeadReq(reqMap);
		reqMap.put("txCode", "debtRegister");// 交易代码
		reqMap.put("accountId", jxAccountId);
	 ...
	 * @param response
	 */
	public static void bidApply(String jxAccountId, String orderId, String txAmount, String productId, String frzFlag,
	...
	public static void autoBidAuthPlus(String jxAccountId, String txAmount, String totAmount, String deadline,
		...
		reqMap.put("lastSrvAuthCode", lastSrvAuthCode);
		reqMap.put("smsCode", smsCode);
		reqMap.put("retUrl", CommonUtil.ADDRESS+"/A04");// 返回交易页面链接
	 ...
	 * @return
	 */
	public static boolean isJxAccount(User user) {
		if (user == null) {
			return false;
		}
	...
	public void jx_synBankCard(User user){
	 ...
	 * @return
	 */
	public static boolean checkBalance(long avBalance,String jxAccountId){
	...
	public static Map<String,Boolean> downFileFromJXFtp(String ftpHost,String ftpUserName,int ftpPort,String ftpPassword){
		...
		String localPathjx = "//data//jx_trace_file//" +dateYear+"//"+dateMonth+"//"+ dateDay;//下载存储的目录
//		String localPathjx = "/download/" +dateYear+"/"+dateMonth+"/"+ dateDay;//下载存储的目录
	 ...
	 * @return
	 */
	public static Map<String, String> autoLendPay(String accountId,String orderId,long txAmount,long feeAmount,String productId){
		Map<String, String> reqMap = new TreeMap<>();
		JXService.getHeadReq(reqMap);
		reqMap.put("txCode", "autoLendPay");// 交易代码
		reqMap.put("accountId", accountId);// 电子账号
		reqMap.put("orderId", orderId);// 订单号
		reqMap.put("txAmount", StringUtil.getMoneyYuan(txAmount));//交易金额
		reqMap.put("feeAmount", StringUtil.getMoneyYuan(feeAmount));//手续费金额
		reqMap.put("riskAmount", "0");//风险准备金
		reqMap.put("productId", productId);//标号
	...
	/**
	 * 代付 WJW
	 * @param orderNo	商户请求订单编号VL16
	 * @param cardNo	银行卡号
	 * @param amount	支付金额(单位元)
	 * @param accName	持卡人姓名
	 * @return
	 */
	public static Map<String, String> T1001(String orderNo,String cardNo,String amount,String accName){
		Map<String, String> reqMap = new TreeMap<>();
		JXService.getHeadReq(reqMap);
		reqMap.put("txCode", "T1001");
		reqMap.put("orderNo", orderNo);//商户请求订单编号VL16
		reqMap.put("cardNo", cardNo);//银行卡号
		reqMap.put("amount", amount);//支付金额
		reqMap.put("accName", accName);//持卡人姓名
	 ...
	 * @return
	 */
	public static Map<String, String> T1003(String orderNo,String cardNo,long amount,String accName){
		Map<String, String> reqMap = new TreeMap<>();
		JXService.getHeadReq(reqMap);
		reqMap.put("txCode", "T1003");
		reqMap.put("orderNo", orderNo);//商户请求订单编号VL16
		reqMap.put("cardNo", cardNo);//银行卡号
		reqMap.put("amount", StringUtil.getMoneyYuan(amount));//支付金额
		reqMap.put("accName", accName);//持卡人姓名
		return JXService.requestCommonTransfer(reqMap);
	}
	/**
	...
	public static void termsAuthPage(String accountId,String name,String idNo,String identity,String autoBid,String autoCredit,String paymentAuth,String repayAuth,String autoBidMaxAmt,String autoBidDeadline,String autoCreditMaxAmt,String autoCreditDeadline,String paymentMaxAmt,String paymentDeadline,String repayMaxAmt,String repayDeadline,String forgotPwdUrl,String retUrl,String notifyUrl,HttpServletResponse response,String remark){
		...
		String sign = SignUtil_lj.sign(mergeMap);
		reqMap.put("sign", sign);
		JXService.formSubmit(JXService.PAGE_URI + "termsAuthPage", reqMap, response,remark);
	}
}
