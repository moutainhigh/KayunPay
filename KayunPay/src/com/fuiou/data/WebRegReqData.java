 ...
 *
 */
public class WebRegReqData implements Serializable {
	/**
	 * 
	 */
	...
	public String createSignValueForReg(){
		String src =back_notify_url+"|"+bank_nm+"|"+capAcntNo+"|"+certif_id+"|"+city_id+"|"+cust_nm+"|"+email+"|"+mchnt_cd+"|"+mchnt_txn_ssn+"|"+mobile_no+"|"+ page_notify_url +"|"+parent_bank_id+"|"+user_id_from;
		...
		System.out.println("个人用户自助开户注册（网页版）请求接口验证签名明文>>>>"+src);
		return src;
	}
