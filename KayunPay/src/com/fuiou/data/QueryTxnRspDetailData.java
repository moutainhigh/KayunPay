 ...
 *
 */
public class QueryTxnRspDetailData {
	...
	public String toString() {
		return "QueryTxnRspDetailData [ext_tp=" + ext_tp + ", txn_date="
				+ txn_date + ", txn_time=" + txn_time + ", src_tp=" + src_tp
				+ ", mchnt_ssn=" + mchnt_ssn + ", txn_amt=" + txn_amt
				+ ", txn_amt_suc=" + txn_amt_suc + ", contract_no="
				+ contract_no + ", out_fuiou_acct_no=" + out_fuiou_acct_no
				+ ", out_cust_no=" + out_cust_no + ", out_artif_nm="
				+ out_artif_nm + ", in_fuiou_acct_no=" + in_fuiou_acct_no
				+ ", in_cust_no=" + in_cust_no + ", in_artif_nm=" + in_artif_nm
				+ ", remark=" + remark + ", txn_rsp_cd=" + txn_rsp_cd
