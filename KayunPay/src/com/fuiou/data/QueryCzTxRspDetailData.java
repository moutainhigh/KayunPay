...
public class QueryCzTxRspDetailData {
	...
	public String toString() {
		return "QueryCzTxRspDetailData [ext_tp=" + ext_tp + ", txn_date="
				+ txn_date + ", txn_time=" + txn_time + ", mchnt_ssn="
				+ mchnt_ssn + ", txn_amt=" + txn_amt + ", fuiou_acct_no="
				+ fuiou_acct_no + ", cust_no=" + cust_no + ", artif_nm="
				+ artif_nm + ", remark=" + remark + ", txn_rsp_cd="
				+ txn_rsp_cd + ", rsp_cd_desc=" + rsp_cd_desc + "]";
	}
